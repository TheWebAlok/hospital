      ...
      <section className="terms-section">
        <div className="container">
          ...
          <div className="tos-content">
            ...
            {/* 1 */}
            <div className="content-section" id="agreement">
              <h3>1. Agreement to Terms</h3>

              <p>
                By accessing our website and services, you agree to be
              ...
              <div className="info-box">
                ...
                <p>
                  These terms apply to all users, visitors, and others
            ...
            {/* 2 */}
            <div className="content-section" id="intellectual-property">
            ...
            {/* 3 */}
            <div className="content-section" id="user-accounts">
              <h3>3. User Accounts</h3>

              <p>
                When you create an account with us, you must provide
                accurate, complete, and current information. Failure to
                do so constitutes a breach of the Terms, which may
            ...
            {/* 4 */}
            <div className="content-section" id="prohibited">
              <h3>4. Prohibited Activities</h3>

              <p>
                You may not access or use the Service for any purpose
                other than that for which we make it available.
              </p>
            ...
            <div className="content-section" id="disclaimer">
              ...
              <p>
                Your use of our service is at your sole risk. The service
            ...
            {/* 6 */}
            <div className="content-section" id="limitation">
            ...
            <div className="content-section" id="indemnification">
              ...
              <p>
                ...
                expenses arising out of your use of the service.
              </p>
            </div>

            {/* 8 */}
            <div className="content-section" id="termination">
              <h3>8. Termination</h3>
            ...
            {/* 9 */}
            <div className="content-section" id="governing-law">
              <h3>9. Governing Law</h3>

              <p>
                These Terms shall be governed by and construed in
                accordance with the laws of [Your Country], without
